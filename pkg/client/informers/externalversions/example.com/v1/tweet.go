...
import (
	...
	versioned "github.com/jonatanblue/tweet-operator/pkg/client/clientset/versioned"
	internalinterfaces "github.com/jonatanblue/tweet-operator/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/jonatanblue/tweet-operator/pkg/client/listers/example.com/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ExampleV1().Tweets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ExampleV1().Tweets(namespace).Watch(context.TODO(), options)
			},
		},
		&examplecomv1.Tweet{},
		resyncPeriod,
...
func (f *tweetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&examplecomv1.Tweet{}, f.defaultInformer)
}
